...
void SingleLinkedList::reverseIterative()
{
   Node *curr=head;
...
Node* SingleLinkedList::reverseRecursive(Node *head)//do a dry run
{
   // dekhte baadmei
}
...
int main()
{
    ...
    l1.display();
    l1.reverseIterative();
    cout<<"This is iterative call"<<endl;
    l1.printReverse(l1.reverseRecursive(l1.getHead()));
    l1.display();
